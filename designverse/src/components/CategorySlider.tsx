...
function CategorySlider() {
    const categories=[
  { id: 1, name: "Premium Banners", icon: Apple, color: "bg-green-100" },
  { id: 2, name: "High Quality Posters", icon: Milk, color: "bg-yellow-100" },
  { id: 3, name: "Event Letters", icon: Wheat, color: "bg-orange-100" },
  { id: 4, name: "Graphics Design", icon: Cookie, color: "bg-pink-100" },
    ]
